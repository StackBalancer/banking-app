...
mock:
	mockgen --package mockdb --destination db/mocks/store.go bank-app/db/sqlc Store

.PHONY: postgres pgadmin createdb dropdb migrateup migratedown sqlc test server mock
